...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Iterator<Customer> iterator = customerCollection.ageIterator((c1, c2) -> {
        ...
        Predicate<Customer> predicate = p -> p.getAddress().getCity().equals("Chicago");

        Iterator<Customer> filterIterator = customerCollection.filterIterator(predicate);
        ...
        Predicate<Customer> predicate1 = p -> p.getAddress().getZip().startsWith("12");
